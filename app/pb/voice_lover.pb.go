...
var file_voice_lover_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x42, 0x2b, 0x5a, 0x29,
...
var file_voice_lover_proto_depIdxs = []int32{
	...
	28, // 5: pb.VoiceLoverMain.audios:type_name -> pb.AudioData
	0,  // 6: pb.RespVoiceLoverMain.data:type_name -> pb.VoiceLoverMain
	24, // 7: pb.AlbumList.albums:type_name -> pb.AlbumData
	2,  // 8: pb.RespAlbumList.data:type_name -> pb.AlbumList
	26, // 9: pb.RecUserList.rec_users:type_name -> pb.UserData
	4,  // 10: pb.RespRecUserList.data:type_name -> pb.RecUserList
	24, // 11: pb.AlbumDetail.album:type_name -> pb.AlbumData
	28, // 12: pb.AlbumDetail.audios:type_name -> pb.AudioData
	6,  // 13: pb.RespAlbumDetail.data:type_name -> pb.AlbumDetail
	29, // 14: pb.AlbumComments.comments:type_name -> pb.CommentData
	8,  // 15: pb.RespAlbumComments.data:type_name -> pb.AlbumComments
	28, // 16: pb.AudioDetail.audio:type_name -> pb.AudioData
	24, // 17: pb.AudioDetail.albums:type_name -> pb.AlbumData
	11, // 18: pb.RespAudioDetail.data:type_name -> pb.AudioDetail
	29, // 19: pb.AudioComments.comments:type_name -> pb.CommentData
	13, // 20: pb.RespAudioComments.data:type_name -> pb.AudioComments
	24, // 21: pb.CollectAlbumList.list:type_name -> pb.AlbumData
	17, // 22: pb.RespCollectAlbumList.data:type_name -> pb.CollectAlbumList
	28, // 23: pb.CollectAudioList.list:type_name -> pb.AudioData
	19, // 24: pb.RespCollectAudioList.data:type_name -> pb.CollectAudioList
	30, // 25: pb.RespShareInfo.data:type_name -> pb.ShareData
