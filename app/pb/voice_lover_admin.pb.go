...
type AdminVoiceLoverAudio struct {
	...
	PubUid       uint64                 `protobuf:"varint,3,opt,name=pub_uid,json=pubUid,proto3" json:"pub_uid,omitempty"`
	...
	EditPubs     []*AdminVoiceLoverEdit `protobuf:"bytes,13,rep,name=edit_pubs,json=editPubs,proto3" json:"edit_pubs,omitempty"`
	EditContents []*AdminVoiceLoverEdit `protobuf:"bytes,14,rep,name=edit_contents,json=editContents,proto3" json:"edit_contents,omitempty"`
	EditPosts    []*AdminVoiceLoverEdit `protobuf:"bytes,15,rep,name=edit_posts,json=editPosts,proto3" json:"edit_posts,omitempty"`
	EditCovers   []*AdminVoiceLoverEdit `protobuf:"bytes,16,rep,name=edit_covers,json=editCovers,proto3" json:"edit_covers,omitempty"`
}
...
func (x *AdminVoiceLoverAudio) GetPubUid() uint64 {
	if x != nil {
		return x.PubUid
	}
	return 0
...
func (x *AdminVoiceLoverAudio) GetSource() uint32 {
	if x != nil {
		return x.Source
	}
	return 0
...
func (x *AdminVoiceLoverAudio) GetAuditStatus() uint32 {
	if x != nil {
...
func (x *AdminVoiceLoverAudio) GetEditPubs() []*AdminVoiceLoverEdit {
	if x != nil {
		return x.EditPubs
	}
	return nil
...
func (x *AdminVoiceLoverAudio) GetEditContents() []*AdminVoiceLoverEdit {
	if x != nil {
...
func (x *AdminVoiceLoverAudio) GetEditPosts() []*AdminVoiceLoverEdit {
	if x != nil {
		return x.EditPosts
	}
	return nil
...
func (x *AdminVoiceLoverAudio) GetEditCovers() []*AdminVoiceLoverEdit {
	if x != nil {
		return x.EditCovers
	}
	return nil
...
type AdminVoiceLoverEdit struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *AdminVoiceLoverEdit) Reset() {
	*x = AdminVoiceLoverEdit{}
	if protoimpl.UnsafeEnabled {
...
func (x *AdminVoiceLoverEdit) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AdminVoiceLoverEdit) ProtoMessage() {}

func (x *AdminVoiceLoverEdit) ProtoReflect() protoreflect.Message {
	mi := &file_voice_lover_admin_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AdminVoiceLoverEdit.ProtoReflect.Descriptor instead.
func (*AdminVoiceLoverEdit) Descriptor() ([]byte, []int) {
	return file_voice_lover_admin_proto_rawDescGZIP(), []int{1}
}

func (x *AdminVoiceLoverEdit) GetUid() uint64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
func (x *AdminVoiceLoverEdit) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *AdminVoiceLoverEdit) GetAvatar() string {
	if x != nil {
		return x.Avatar
	}
	return ""
...
var file_voice_lover_admin_proto_rawDesc = []byte{
	...
	0x6d, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0xb4, 0x04,
	...
	0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x70, 0x75, 0x62, 0x55, 0x69, 0x64,
	...
	0x12, 0x16, 0x0a, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0d,
	...
	,
	...
	,
	...
	0x09, 0x52, 0x06, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x22, 0x66, 0x0a, 0x1c, 0x52, 0x65, 0x73,
	0x70, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x56, 0x6f, 0x69, 0x63, 0x65, 0x4c, 0x6f, 0x76, 0x65, 0x72,
	0x41, 0x75, 0x64, 0x69, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x30, 0x0a, 0x06, 0x61, 0x75, 0x64,
	0x69, 0x6f, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x70, 0x62, 0x2e, 0x41,
	...
	0x6c, 0x22, 0x50, 0x0a, 0x1e, 0x52, 0x65, 0x73, 0x70, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x56, 0x6f,
	0x69, 0x63, 0x65, 0x4c, 0x6f, 0x76, 0x65, 0x72, 0x41, 0x75, 0x64, 0x69, 0x6f, 0x44, 0x65, 0x74,
	0x61, 0x69, 0x6c, 0x12, 0x2e, 0x0a, 0x05, 0x61, 0x75, 0x64, 0x69, 0x6f, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x18, 0x2e, 0x70, 0x62, 0x2e, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x56, 0x6f, 0x69,
	0x63, 0x65, 0x4c, 0x6f, 0x76, 0x65, 0x72, 0x41, 0x75, 0x64, 0x69, 0x6f, 0x52, 0x05, 0x61, 0x75,
	0x64, 0x69, 0x6f, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_voice_lover_admin_proto_goTypes = []interface{}{
	...
	(*AdminVoiceLoverEdit)(nil),            // 1: pb.AdminVoiceLoverEdit
...
var file_voice_lover_admin_proto_depIdxs = []int32{
	1, // 0: pb.AdminVoiceLoverAudio.edit_pubs:type_name -> pb.AdminVoiceLoverEdit
	1, // 1: pb.AdminVoiceLoverAudio.edit_contents:type_name -> pb.AdminVoiceLoverEdit
	1, // 2: pb.AdminVoiceLoverAudio.edit_posts:type_name -> pb.AdminVoiceLoverEdit
	1, // 3: pb.AdminVoiceLoverAudio.edit_covers:type_name -> pb.AdminVoiceLoverEdit
...
func file_voice_lover_admin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_voice_lover_admin_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AdminVoiceLoverEdit); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
