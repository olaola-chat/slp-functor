...
func (v *voiceLoverActivityRankAwardDao) GetOne(ctx context.Context, id uint32) (*functor.EntityVoiceLoverActivityRankAward, error) {
	return functor2.VoiceLoverActivityRankAward.Ctx(ctx).Where("id = ?", id).FindOne()
}
